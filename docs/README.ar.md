...
<h3 align="center">انشر وكلاء الذكاء الاصطناعي كالمحترفين — بدون محطة طرفية، بدون إعدادات، بنقرة واحدة.</h3>

<p align="center">
  تثبيت OpenClaw و Claude Code و ZeroClaw والمزيد بنقرة واحدة · التبديل بين النماذج بحرية على الخوادم المحلية · التحكم في جميع الوكلاء من شاشة واحدة.
</p>
...
| NanoBot | OpenAI / Anthropic | نقرة واحدة |
| PicoClaw | OpenAI / Anthropic | نقرة واحدة |
| Hermes Agent | OpenAI / Anthropic | نقرة واحدة |
